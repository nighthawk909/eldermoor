...
The **standard**. CLAUDE.md says *don't shortcut*; MANIFEST.md says *what* to build; this
file says *what "good" means*, in numbers and checks an agent can execute and verify.

> How to use: every MANIFEST chunk's Definition of Done points here. A chunk is `done`
