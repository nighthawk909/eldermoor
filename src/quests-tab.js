...
export function initQuestsTab(){
  ...
  function findQuest(id){ return questList().find(q => q && q.id === id) || null; }
  ...
  .emq-detail .req.met{color:#5fc14b;} .emq-detail .req.met:before{content:"✓";color:#5fc14b;}
  .emq-detail .req.unmet{color:#d14b3a;} .emq-detail .req.unmet:before{content:"✗";color:#d14b3a;}
  ...
  window.addEventListener('em-data-ready', () => {
    ...
    } catch { /* HUD not ready - nothing to refresh */ }
  });
}
